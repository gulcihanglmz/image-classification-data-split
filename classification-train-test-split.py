...
source_dir = r"D:\\3.sınıf\\Pattern\\Images"  # kaynak dizin
target_dir = r"D:\\3.sınıf\\Pattern\\dataset"  # hedef dizin

# Etiket klasörlerinin listesi
labels = [
    "Fresh-Apple", "Fresh-Banana", "Fresh-Grape", "Fresh-Mango", "Fresh-Orange",
    "Rotten-Apple", "Rotten-Banana", "Rotten-Grape", "Rotten-Mango", "Rotten-Orange"
]
...
for label in labels:
    label_source_dir = os.path.join(source_dir, label)  # 'train' alt klasörü kaldırıldı
